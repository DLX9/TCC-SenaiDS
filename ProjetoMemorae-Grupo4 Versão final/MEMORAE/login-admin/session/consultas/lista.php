...
<body class="back">
  ...
  <header class="head">
    ...
    <a href="../nova/nova.php"><button type="button" class="btn btn-success fw-bold">Cadastrar Médico</button></a>
    ...
    $CON = "SELECT id, id_medico, dia, horario, ativo FROM consulta WHERE ativo = 1 AND id_clinica = $idcli";
