...
<body class="back">
    ...
    <h1 class="text-uppercase title">Memorae</h1>
        ...
        <div class="bnts">
            ...
            <a href="nova.php"><button type="button" class="btn btn-success fw-bold">Cadastrar Médico</button></a>
    ...
    <center>
    <h2 class="text-uppercase top">Cadastrando...</h2>
    <form action="proccess-nova.php" method="post" class="main">
    ...
    <input name="idmd" type="hidden" value="<?php print($idmd); ?>">
        ...
        <button type="submit" class="btn btn-success fw-bold">Proximo Passo</button>
    </form>
    <br>
